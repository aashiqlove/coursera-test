...
/*function data1(box){
    ...
    var element = doc.querySelector(box).innerHTML;
...
*/
function data1(box){
var in_content=document.querySelector(".in_content");
var pr=document.querySelector(".pr");
var ne=document.querySelector(".ne");
if(box==".div1"||box==".div7"){
...
if(box==".div0"){
	var syn=`<h1 style="text-align:center;">இன்றைய செய்தி</h1>
	<marquee id="marquee" onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="350" width="100%" direction="up" height="90%">
	${div0}</marquee>`
	content.innerHTML=syn;		
	
}
else if(box==".div1"){
	var syn =`<h1>வங்கி விவசாயி கடன் விவரங்கள்</h1>
	<div class="in_content">${div1}</div>`;
	content.innerHTML=syn;
}
else if(box==".div2"){
	var syn =`<h1 >தானிய விலை</h1>
	<div class="in_content">${div2}</div>`;
	content.innerHTML=syn;
}
else if(box==".div3"){
	var syn =`<h1>காய்கறி விலை</h1>
	<div class="in_content">${div3}</div>`;
	content.innerHTML=syn;			
}
else if(box==".div4"){
	var syn =`<h1>வானிலை</h1>
	<div class="in_content">${div4}</div>`;
	content.innerHTML=syn;
}
else if(box==".div5"){
	var syn =`<h1>விதை இருப்பு</h1>
	<div class="in_content">${div5}</div>`;
	content.innerHTML=syn;
}
else if(box==".div6"){
	var syn =`<h1>உரம் இருப்பு</h1>
	<div class="in_content">${div6}</div>`;
	content.innerHTML=syn;
}
else if(box==".div7"){
	var syn =`<h1>அரசு மானியங்கள்</h1>
	<div class="in_content">${div7}</div>`;
	content.innerHTML=syn;
}
else if(box==".div8"){
	var syn =`<h1>வானிலை ஆலோசனை</h1>
	<div class="in_content">${div8}</div>`;
	content.innerHTML=syn;
}
}
...
function boxarea_default(){
	fetch("./Widgets-Details-forNewSite/tamil/koyambedu.html")
    .then(response => {
    ...
    .then(html => {
        ...
        const basicDetailsDiv0 = tempContainer.querySelector('.div0');
        ...
        const basicDetailsDiv7 = tempContainer.querySelector('.div7');
        const basicDetailsDiv8 = tempContainer.querySelector('.div8');
      
      
      div0=basicDetailsDiv2.outerHTML;
      div1=basicDetailsDiv0.outerHTML;
      div2=basicDetailsDiv1.outerHTML;
      div3=basicDetailsDiv3.outerHTML;
      div4=basicDetailsDiv4.outerHTML;
      div5=basicDetailsDiv5.outerHTML;
      div6=basicDetailsDiv6.outerHTML;
      div7=basicDetailsDiv7.outerHTML;
      div8=basicDetailsDiv8.outerHTML;
      
      
      	const contentContainer0 = document.querySelector('.contentContainer0');
        const contentContainer1 = document.querySelector('.contentContainer1');
        const contentContainer2 = document.querySelector('.contentContainer2');
        const contentContainer3 = document.querySelector('.contentContainer3');
        const contentContainer4 = document.querySelector('.contentContainer4');
        const contentContainer5 = document.querySelector('.contentContainer5');
        const contentContainer6 = document.querySelector('.contentContainer6');
        const contentContainer7 = document.querySelector('.contentContainer7');
        const contentContainer8 = document.querySelector('.contentContainer8');
        
        
       
        if (basicDetailsDiv0,basicDetailsDiv1,basicDetailsDiv2,basicDetailsDiv3,basicDetailsDiv4,basicDetailsDiv5,basicDetailsDiv6.basicDetailsDiv7,basicDetailsDiv8) {
            contentContainer0.innerHTML=basicDetailsDiv0.outerHTML;
            contentContainer1.innerHTML=basicDetailsDiv1.outerHTML;
            contentContainer2.innerHTML=basicDetailsDiv2.outerHTML;
            contentContainer3.innerHTML=basicDetailsDiv3.outerHTML;
            contentContainer4.innerHTML=basicDetailsDiv4.outerHTML;
            contentContainer5.innerHTML=basicDetailsDiv5.outerHTML;
            contentContainer6.innerHTML=basicDetailsDiv6.outerHTML;
            contentContainer7.innerHTML=basicDetailsDiv7.outerHTML;
            contentContainer8.innerHTML=basicDetailsDiv8.outerHTML;
...
console.log(val);
	fetch("./Widgets-Details-forNewSite/tamil/"+val+".html")
    .then(response => {
